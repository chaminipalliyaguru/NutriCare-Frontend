        ...
        <>
            <div className="pt-20 px-12">
                ...
                <div className="my-3 bg-white border-1 shadow-md rounded-md p-4">
                    <input type="text" onChange={e => setdocPosition(e.target.value)} value={docPosition} placeholder="Search by docPosition" className="border-1 border-gray-300 rounded-md p-2" />
                </div>
