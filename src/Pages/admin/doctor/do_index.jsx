...
export default function DoctorAdmin() {
    ...
    async function getAll() {
        try {
            setLoading(true);
            const response = await axios.get('https://nutricare-backend.vercel.app/doctor/get-all');
    ...
    async function searchDoctor() {
        try {
            ...
            if (docPosition === '') {
                ...
                const resp = await axios.get('https://nutricare-backend.vercel.app/doctor/search/' + docPosition);
    ...
    async function deleteDoctor(doctor) {
        try {
            ...
            if (window.confirm('Are you sure you want to delete this Doctor?')) {
                const response = await axios.delete('https://nutricare-backend.vercel.app/doctor/delete/' + doctor._id);
