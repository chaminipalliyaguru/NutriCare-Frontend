...
export default function ArticleAdmin() {
    ...
    async function getAll() {
        try {
            setLoading(true);
            const response = await axios.get('https://nutricarebe-ffhmggb4gefgbwch.eastus-01.azurewebsites.net/article/get-all');
    ...
    async function searchArticle() {
        try {
            ...
            if (title === '') {
                ...
                const resp = await axios.get('https://nutricarebe-ffhmggb4gefgbwch.eastus-01.azurewebsites.net/article/search/' + title);
    ...
    async function deleteArticle(article) {
        try {
            ...
            if (window.confirm('Are you sure you want to delete this Article?')) {
                const response = await axios.delete('https://nutricarebe-ffhmggb4gefgbwch.eastus-01.azurewebsites.net/article/delete/' + article._id);
