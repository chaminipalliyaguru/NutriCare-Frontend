...
//     <div>
//       <section id="Projects"
//     className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-44 mt-10 mb-5 mr-36 mt-24">

    {/* <!--   ✅ Product card 1 - Starts Here 👇 --> */}
    // <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl ml-64">
    //     <a href="#">
    //         <img src={img_2}
    ...
    // <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl ml-24">
    //     <a href="#">
    //         <img src={img_3}
    //                 alt="Product" className="h-80 w-72 object-cover rounded-t-xl" />
    ...
    //           </h4>
    //           <p className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700">
    //           This tuna recipe mixes fresh fish with olive oil, lemon, herbs, and chickpeas, creating a delicious blend of Mediterranean flavors that is both healthy and satisfying.
    //           </p>
    //           <div className="pt-6">
    //             <p className="block font-sans text-base antialiased font-normal leading-relaxed text-inherit">
    ...
    // <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl mr-8">
    //     <a href="#">
    //         <img src={img_4}
    //                 alt="Product" className="h-80 w-72 object-cover rounded-t-xl" />
    //         <div className="px-4 py-3 w-72">
...
const Products = [
  {
    ...
    description:
      "Enjoy these shrimp lettuce wraps filled with crisp veggies and juicy shrimp sautéed with garlic and soy sauce. Add sesame seeds and lime.",
    time: "10 Min - easy prep - 2 serves",
    image_url: img_2,
  },
  {
    id: "2",
    title: "Seared Tuna with Bulgur & Chickpea Salad",
    description:
  ...
  {
    id: "3",
    title: "Lemon-Herb Salmon with Caponata & Farro",
    description:
      "Mediterranean dinner with farm-fresh veggies, paired perfectly with brown rice and red wine, creates a harmonious blend of flavors for a delightful evening.",
    time: "20 min - easy prep - 2 serves",
    image_url: img_4,
  },
];
...
function Home_card() {
  return (
    <section
      id="Projects"
      className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-44 ml-0 mb-5 mr-36 mt-24"
    >
