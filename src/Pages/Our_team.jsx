...
<div class="text-center p-10">
    ...
    <p class='mt-6'>Get to know the passionate individuals behind NutriCure, dedicated to bringing you</p> 
...
<section id="Projects"
    ...
    <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            ...
            <div class="px-4 py-3 w-72">
                ...
                <p class="text-2xl text-center font-bold text-black truncate block capitalize mt-4">Sahan Madushka</p>
                    <p class="text-lg text-center text-black cursor-auto my-2">Back-End Developer</p>
                    {/* <del>
    ...
    <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            ...
            <p class="text-lg text-center text-black cursor-auto my-2">Front-End Developer</p>
            </div>
        </a>
    </div>
